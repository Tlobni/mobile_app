...
import 'package:tlobni/ui/screens/chat/chat_audio/widgets/record_button.dart';
import 'package:tlobni/ui/screens/widgets/animated_routes/transparant_route.dart';
...
class _ChatScreenState extends State<ChatScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    notificationStreamSubscription = notificationStream.listen((PermissionStatus permissionStatus) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.status == "sold out" && widget.isPurchased == 1 && !widget.alreadyReview) {
        ratingsAlertDialog();
      }
    });
  }
          ...
          content: BlocListener<AddItemReviewCubit, AddItemReviewState>(
            listener: (context, state) {
              if (state is AddItemReviewInSuccess) {
                ...
                context.read<GetBuyerChatListCubit>().updateAlreadyReview(int.parse(widget.itemId));
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          UiUtils.buildButton(context, showElevation: false, onPressed: () {
                            context
                                .read<AddItemReviewCubit>()
                                .addItemReview(itemId: int.parse(widget.itemId), rating: _rating, review: _feedbackController.text.trim());
                          },
                              fontSize: 12,
                              disabled: _rating < 1,
                  ...
                  if (supportedImageTypes.contains(attachmentMIME)) ...[
                    Container(
                      decoration: BoxDecoration(
                          color: context.color.secondaryColor, border: Border.all(color: context.color.borderColor, width: 1.5)),
                      child: Row(
                        children: [
                          Padding(
                                                        ...
                                                        onPressed: () async {
                                                          try {
                                                            if (messageAttachment == null) {
                                                              ...
                                                              if (pickedAttachment != null && pickedAttachment.files.isNotEmpty) {
                                                                final file = pickedAttachment.files.first;
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  ...
                                  softWrap: true,
                                  style: TextStyle(color: context.color.textDefaultColor, fontSize: context.font.large),
                                ),
                              ),
                              Padding(
                      ...
                      if (state is LoadChatMessagesSuccess) {
                        ...
                        if (widget.isFromBuyerList != null) {
                          if (widget.isFromBuyerList!) {
                            context.read<GetBuyerChatListCubit>().removeUnreadCount(widget.itemOfferId);
                          } else {
                            context.read<GetSellerChatListCubit>().removeUnreadCount(widget.itemOfferId);
                          }
                        }
                      }
                    },
                              ...
                              builder: (context, AsyncSnapshot<List<Widget>> snapshot) {
                                ...
                                if (state is LoadChatMessagesSuccess) {
                                  if (state.isLoadingMore) {
                                    loadingMoreWidget = CustomText("loading".translate(context));
                                  }
                                }
                                        ...
                                        Expanded(
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return Column(
                                                mainAxisSize: MainAxisSize.min,
                                                children: [if (index == snapshot.data!.length - 1) offerWidget(), chat],
                                              );
                                            },
                                          ),
                                        ),
        ...
        return Align(
          ...
          child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomText("yourOffer".translate(context), color: context.color.textDefaultColor.withValues(alpha: 0.5)),
                  CustomText(
        ...
        return Align(
          ...
          child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomText("offerLbl".translate(context), color: context.color.textDefaultColor.withValues(alpha: 0.5)),
                  CustomText(
